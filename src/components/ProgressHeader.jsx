...
const ProgressHeader = ({ currentStep = 1, totalSteps = 6, onBack, onLogout }) => {
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-12 py-4">
        ...
        <div className="hidden md:flex flex-1 items-center mx-4 lg:mx-8 xl:mx-12 max-w-5xl">
          <div className="relative w-full" style={{ height: '60px' }}>
            ...
            {/* Boat/Ferry icon positioned on the line */}
            <div 
            ...
            >
              ...
              >
                {/* Ferry/Cruise ship icon with multiple decks */}
        ...
        {/* Mobile progress indicator with boat */}
        <div className="md:hidden flex-1 mx-4">
          ...
          <div className="relative w-full" style={{ height: '32px' }}>
            ...
            {/* Progress line */}
            <div
              className="absolute h-1 bg-orange-500 rounded-full transition-all duration-500 ease-in-out"
              style={{ 
                width: `${pct}%`, 
                top: '50%', 
                transform: 'translateY(-50%)'
